/**
 * @file ReadResistiveMoisture.cpp
 * @author Olivier C
 * @brief This file contains the implementation of the ReadResistiveMoisture class.
 * 
 * The ReadResistiveMoisture class is responsible for reading the moisture level from a sensor,
...
#include <Arduino.h>
#include "ReadResistiveMoisture.h"


/*------------------------------------------------
 Constructors
------------------------------------------------*/
ReadResistiveMoisture::ReadResistiveMoisture (int sensorId, float calibrationValue, float additionalParam){ 
  // Set member values
  _devicePin = sensorId;
...
// Destructor
ReadResistiveMoisture::~ReadResistiveMoisture() { 
}
...
* Methods
*/
void ReadResistiveMoisture::Start (){ 
  #ifdef DEBUG
...
void ReadResistiveMoisture::Update() {    
  float sensorReading;
...
void ReadResistiveMoisture::Stop (ResponseData *responseData) { 
